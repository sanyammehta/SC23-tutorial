...
class CkIndex_ComputeMgr:public CkIndex_IrrGroup{
  public:
    ...
    static int reg_recvNonbondedMICSlaveReady_marshall27();
    // Entry point index lookup
    
    inline static int idx_recvNonbondedMICSlaveReady_marshall27() {
      static int epidx = reg_recvNonbondedMICSlaveReady_marshall27();
      return epidx;
    }

    
    inline static int idx_recvNonbondedMICSlaveReady(void (ComputeMgr::*)(int impl_noname_3, int impl_noname_4, int impl_noname_5) ) {
      return idx_recvNonbondedMICSlaveReady_marshall27();
    }


    
    static int recvNonbondedMICSlaveReady(int impl_noname_3, int impl_noname_4, int impl_noname_5) { return idx_recvNonbondedMICSlaveReady_marshall27(); }
    
    static void _call_recvNonbondedMICSlaveReady_marshall27(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_recvNonbondedMICSlaveReady_marshall27(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_recvNonbondedMICSlaveReady_marshall27(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_recvNonbondedMICSlaveReady_marshall27(PUP::er &p,void *msg);
    ...
    static int reg_recvMICPEData_marshall29();
    // Entry point index lookup
    
    inline static int idx_recvMICPEData_marshall29() {
      static int epidx = reg_recvMICPEData_marshall29();
      return epidx;
    }

    
    inline static int idx_recvMICPEData(void (ComputeMgr::*)(int impl_noname_6, int impl_noname_7) ) {
      return idx_recvMICPEData_marshall29();
    }


    
    static int recvMICPEData(int impl_noname_6, int impl_noname_7) { return idx_recvMICPEData_marshall29(); }
    
    static void _call_recvMICPEData_marshall29(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_recvMICPEData_marshall29(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_recvMICPEData_marshall29(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_recvMICPEData_marshall29(PUP::er &p,void *msg);
};
/* --------------- element proxy ------------------ */
...
class Closure_ComputeMgr {
  public:
    ...
    struct recvNonbondedMICSlaveReady_27_closure;



    struct recvMICPEData_29_closure;
