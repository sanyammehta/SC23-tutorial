...
void cuda_bind_GBIS_psiSum(GBReal *psiSumH) {
  cudaHostGetDevicePointer((void **)&psiSumD, psiSumH, 0);
...
void cuda_bind_GBIS_dEdaSum(GBReal *dEdaSumH) {
  cudaHostGetDevicePointer((void **)&dEdaSumD, dEdaSumH, 0);
