...
void PmeZPencil::_serial_0(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeZPencil_serial_0()), CkMyPe(), 0, &projID, this); 
  {
...
void PmeZPencil::_serial_1(PmePencilInitMsg* gen0, Closure_PmeZPencil::dummyRecvGrid_6_closure* gen1) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeZPencil_serial_1()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    {
      int& pe = gen1->getP0();
...
void PmeZPencil::_serial_2(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeZPencil_serial_2()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 47 "inc/ComputePmeMgr.ci"
 hasData = 0; 
#line 2004 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _for_0(gen0);
...
void PmeZPencil::_serial_3(PmePencilInitMsg* gen0, PmeGridMsg* gen1) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeZPencil_recv_grid()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    {
      PmeGridMsg*& msg = gen1;
...
void PmeZPencil::_serial_4(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeZPencil_forward_fft()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 55 "inc/ComputePmeMgr.ci"
 forward_fft(); 
#line 2158 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_4_end(gen0);
...
void PmeZPencil::_serial_5(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeZPencil_send_trans()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 57 "inc/ComputePmeMgr.ci"
 send_trans(); 
#line 2176 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _if_1(gen0);
...
void PmeZPencil::_serial_6(PmePencilInitMsg* gen0, PmeUntransMsg* gen1) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeZPencil_recv_untrans()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    {
      PmeUntransMsg*& msg = gen1;
...
void PmeZPencil::_serial_7(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeZPencil_backward_fft()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 64 "inc/ComputePmeMgr.ci"
 backward_fft(); 
#line 2329 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_5_end(gen0);
...
void PmeZPencil::_serial_8(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeZPencil_send_ungrid()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
...
void PmeZPencil::_serial_9(PmePencilInitMsg* gen0, PmeAckMsg* gen1) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeZPencil_serial_9()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    {
      PmeAckMsg*& msg = gen1;
...
void PmeYPencil::_serial_0(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeYPencil_serial_0()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
...
void PmeYPencil::_serial_1(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeYPencil_serial_1()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 89 "inc/ComputePmeMgr.ci"
 hasData = 0; 
#line 3325 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _for_0(gen0);
...
void PmeYPencil::_serial_2(PmePencilInitMsg* gen0, PmeTransMsg* gen1) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeYPencil_recv_trans()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    {
      PmeTransMsg*& msg = gen1;
...
void PmeYPencil::_serial_3(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeYPencil_forward_fft()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 98 "inc/ComputePmeMgr.ci"
 forward_fft(); 
#line 3480 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_3_end(gen0);
...
void PmeYPencil::_serial_4(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeYPencil_send_trans()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 100 "inc/ComputePmeMgr.ci"
 send_trans(); 
#line 3498 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _if_1(gen0);
...
void PmeYPencil::_serial_5(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeYPencil_send_untrans1()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 110 "inc/ComputePmeMgr.ci"
 send_untrans(); 
#line 3565 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _for_1(gen0);
...
void PmeYPencil::_serial_6(PmePencilInitMsg* gen0, PmeAckMsg* gen1) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeYPencil_serial_6()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    {
      PmeAckMsg*& msg = gen1;
...
void PmeYPencil::_serial_7(PmePencilInitMsg* gen0, PmeUntransMsg* gen1) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeYPencil_recv_untrans()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    {
      PmeUntransMsg*& msg = gen1;
...
void PmeYPencil::_serial_8(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeYPencil_backward_fft()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 107 "inc/ComputePmeMgr.ci"
 backward_fft(); 
#line 3795 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _serial_9(gen0);
...
void PmeYPencil::_serial_9(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeYPencil_send_untrans0()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 108 "inc/ComputePmeMgr.ci"
 send_untrans(); 
#line 3813 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_6_end(gen0);
...
void PmeXPencil::_serial_0(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeXPencil_serial_0()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
...
void PmeXPencil::_serial_1(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeXPencil_serial_1()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 128 "inc/ComputePmeMgr.ci"
 hasData = 0; 
#line 4456 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _for_0(gen0);
...
void PmeXPencil::_serial_2(PmePencilInitMsg* gen0, PmeTransMsg* gen1) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeXPencil_recv_trans()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    {
      PmeTransMsg*& msg = gen1;
...
void PmeXPencil::_serial_3(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeXPencil_forward_fft()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
...
void PmeXPencil::_serial_4(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeXPencil_pme_kspace()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 138 "inc/ComputePmeMgr.ci"
 pme_kspace(); 
#line 4629 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _serial_5(gen0);
...
void PmeXPencil::_serial_5(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeXPencil_backward_fft()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 139 "inc/ComputePmeMgr.ci"
 backward_fft(); 
#line 4647 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_3_end(gen0);
...
void PmeXPencil::_serial_6(PmePencilInitMsg* gen0) {
  CmiObjId projID = this->ckGetArrayIndex().getProjectionID();
  _TRACE_BEGIN_EXECUTE_DETAILED(-1, -1, (_sdag_idx_PmeXPencil_send_untrans()), CkMyPe(), 0, &projID, this); 
  {
    PmePencilInitMsg*& initmsg = gen0;
    { // begin serial block
#line 141 "inc/ComputePmeMgr.ci"
 send_untrans(); 
#line 4665 "ComputePmeMgr.def.h"
    } // end serial block
  }
  _TRACE_END_EXECUTE(); 
  _slist_1_end(gen0);
